...
const double Half_crossing_angle_B1			= 140e-6 ;
...
double ProcessTFS(bool skip_Dx, bool skip_x)
{
	...
	tfsfile.open("result/twiss_lhcb1.tfs") ;
	string line ;
...
void fcn(Int_t &npar, double *gin, double &f, double *MinuitParameter, int iflag)
{
	...
	ofstream perturbations("temporary_perturbation_b1.madx") ;
	...
	system("/afs/cern.ch/user/m/mad/bin/madx job_sample_b1.madx > /dev/null") ;
	...
	momentum_perturbations2 << "TOTEMDELTAP:=(-0.039217 / 2.0);" << endl ;
...
void InitObservations()
{
	...
	ObservationsPerDetector.detector_name			= "\"XRPH.C6R5.B1\"" ;

	ObservationsPerDetector.Dx_m 				= -7.038e-2 ;							// TOTEM dispersion estimation
	ObservationsPerDetector.Dx_m_rel_error			= 5.23e-2 ;
	...
	ObservationsPerDetector.detector_name			= "\"XRPH.D6R5.B1\"" ;

	ObservationsPerDetector.Dx_m 				= -8.46e-2 ;							// TOTEM dispersion estimation
	ObservationsPerDetector.Dx_m_rel_error			= 6.3e-2 ;
	...
	ObservationsPerDetector.detector_name			= "\"XRPV.C6R5.B1\"" ;
	...
	ObservationsPerDetector.beam_position_x_m 		= 3.4e-3 ;
	...
	ObservationsPerDetector.detector_name			= "\"BPMSW.1R5.B1\"" ;
	...
	ObservationsPerDetector.beam_position_x_m 		= 3.7e-3 ;
	...
	ObservationsPerDetector.detector_name			= "\"BPM.5R5.B1\"" ;
	...
	ObservationsPerDetector.beam_position_x_m 		= 2.789e-3 ;
	ObservationsPerDetector.beam_position_x_m_rel_error 	= ((427.20e-6) / ObservationsPerDetector.beam_position_x_m) ; // After discussion with BPM experts on 2016.08.04
	ObservationsPerDetector.valid_x 			= true ;

	map_from_detector_name_to_ObservationsPerDetector[ObservationsPerDetector.detector_name] = ObservationsPerDetector ;

	ObservationsPerDetector.detector_name			= "\"BPMSY.4R5.B1\"" ;
	...
	ObservationsPerDetector.beam_position_x_m 		= 9.789e-03 ;
	ObservationsPerDetector.beam_position_x_m_rel_error 	= ((427.20e-6) / ObservationsPerDetector.beam_position_x_m) ; // After discussion with BPM experts on 2016.08.04
	ObservationsPerDetector.valid_x 			= false ;
...
void InitPerturbations()
{
	...
	Perturbation.name 	 	= "Half_crossing_angle_B1" ;
	Perturbation.type 	 	= horizontal_crossing_angle_B1 ;
	...
	Perturbation.name 	 	= "MQXB.A2R5" ;
	vector_of_Perturbation.push_back(Perturbation) ;
	Perturbation.name 	 	= "MQXB.B2R5" ;
	vector_of_Perturbation.push_back(Perturbation) ;
	Perturbation.name 	 	= "MQXA.3R5" ;
	vector_of_Perturbation.push_back(Perturbation) ;
	Perturbation.name 	 	= "MQY.4R5.B1" ;
	vector_of_Perturbation.push_back(Perturbation) ;
	Perturbation.name 	 	= "MQML.5R5.B1" ;
	vector_of_Perturbation.push_back(Perturbation) ;
