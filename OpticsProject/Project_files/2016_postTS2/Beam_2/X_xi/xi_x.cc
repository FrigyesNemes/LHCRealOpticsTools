...
int main()
{
	...
	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_x_PTGraph.begin() ; it != map_from_element_name_to_x_PTGraph.end(); ++it)
	{
		...
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
	...
	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_Lx_PTGraph.begin() ; it != map_from_element_name_to_Lx_PTGraph.end(); ++it)
	{
		cout << it->first << endl ;

		string graph_name = "Lx_" + it->first.substr(1, 4) + "_" + it->first.substr(6, 4) + "_" + it->first.substr(11, 2) ;

		it->second->SetName(graph_name.c_str()) ;
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
		it->second->GetYaxis()->SetTitle("Lx [m]") ;

		it->second->Write() ;
		
	} 

	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_Ly_PTGraph.begin() ; it != map_from_element_name_to_Ly_PTGraph.end(); ++it)
	{
		cout << it->first << endl ;

		string graph_name = "Ly_" + it->first.substr(1, 4) + "_" + it->first.substr(6, 4) + "_" + it->first.substr(11, 2) ;

		it->second->SetName(graph_name.c_str()) ;
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
		it->second->GetYaxis()->SetTitle("Ly [m]") ;

		it->second->Write() ;
		
	} 

	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_vx_PTGraph.begin() ; it != map_from_element_name_to_vx_PTGraph.end(); ++it)
	{
		cout << it->first << endl ;

		string graph_name = "vx_" + it->first.substr(1, 4) + "_" + it->first.substr(6, 4) + "_" + it->first.substr(11, 2) ;

		it->second->SetName(graph_name.c_str()) ;
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
		it->second->GetYaxis()->SetTitle("vx") ;

		it->second->Write() ;
		
	} 

	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_vy_PTGraph.begin() ; it != map_from_element_name_to_vy_PTGraph.end(); ++it)
	{
		cout << it->first << endl ;

		string graph_name = "vy_" + it->first.substr(1, 4) + "_" + it->first.substr(6, 4) + "_" + it->first.substr(11, 2) ;

		it->second->SetName(graph_name.c_str()) ;
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
		it->second->GetYaxis()->SetTitle("vy") ;

		it->second->Write() ;
		
	} 

	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_Dx_PTGraph.begin() ; it != map_from_element_name_to_Dx_PTGraph.end(); ++it)
	{
		cout << it->first << endl ;

		string graph_name = "Dx_" + it->first.substr(1, 4) + "_" + it->first.substr(6, 4) + "_" + it->first.substr(11, 2) ;

		it->second->SetName(graph_name.c_str()) ;
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
		it->second->GetYaxis()->SetTitle("Dx [m[") ;

		it->second->Write() ;
		
	} 

	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_Dy_PTGraph.begin() ; it != map_from_element_name_to_Dy_PTGraph.end(); ++it)
	{
		cout << it->first << endl ;

		string graph_name = "Dy_" + it->first.substr(1, 4) + "_" + it->first.substr(6, 4) + "_" + it->first.substr(11, 2) ;

		it->second->SetName(graph_name.c_str()) ;
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
		it->second->GetYaxis()->SetTitle("Dy [m]") ;

		it->second->Write() ;
		
	} 

	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_dLx_ds_PTGraph.begin() ; it != map_from_element_name_to_dLx_ds_PTGraph.end(); ++it)
	{
		cout << it->first << endl ;

		string graph_name = "dLxds_" + it->first.substr(1, 4) + "_" + it->first.substr(6, 4) + "_" + it->first.substr(11, 2) ;

		it->second->SetName(graph_name.c_str()) ;
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
		it->second->GetYaxis()->SetTitle("dLx/ds") ;

		it->second->Write() ;
		
	} 

	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_dLy_ds_PTGraph.begin() ; it != map_from_element_name_to_dLy_ds_PTGraph.end(); ++it)
	{
		cout << it->first << endl ;

		string graph_name = "dLyds_" + it->first.substr(1, 4) + "_" + it->first.substr(6, 4) + "_" + it->first.substr(11, 2) ;

		it->second->SetName(graph_name.c_str()) ;
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
		it->second->GetYaxis()->SetTitle("dLy/ds") ;

		it->second->Write() ;
		
	} 

	for(map_from_element_name_to_PTGraph_type::iterator it = map_from_element_name_to_Ly_over_dLy_ds_PTGraph.begin() ; it != map_from_element_name_to_Ly_over_dLy_ds_PTGraph.end(); ++it)
	{
		cout << it->first << endl ;

		string graph_name = "Ly_over_dLyds_" + it->first.substr(1, 4) + "_" + it->first.substr(6, 4) + "_" + it->first.substr(11, 2) ;

		it->second->SetName(graph_name.c_str()) ;
		it->second->GetXaxis()->SetTitle("#xi [fraction]") ;
		it->second->GetYaxis()->SetTitle("(Ly / dLy/ds) [m]") ;
